# -*- coding: utf-8 -*-
# Migration script for Loopjet Integration v18.0.1.0.5
...
def migrate(cr, version):
    """
    Migration for version 18.0.1.0.5
    ...
    """
    _logger.info("=" * 80)
    _logger.info("Migrating Loopjet Integration to version 18.0.1.0.5")
    _logger.info("=" * 80)
    ...
    _logger.info("Migration to 18.0.1.0.5 completed successfully")
    _logger.info("=" * 80)
